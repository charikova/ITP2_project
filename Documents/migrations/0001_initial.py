# Generated by Django 2.0.1 on 2018-01-31 05:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default='2018-01-31 05:50')),
                ('returning_date', models.DateTimeField(default='2018-01-31 05:50')),
                ('time_left', models.CharField(max_length=250, null=True)),
                ('checked_up_by_whom', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='AVFile',
